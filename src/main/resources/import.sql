...
INSERT INTO user (id, about, created, photo_id, email, firstname, logged, password, phone, surname, title, group_id, role_id, company_id, is_approved, token) VALUES (1, '',0,null,'admin@admin.com','admin', 0,'{bcrypt}$2a$10$aZA5V4s65.eiEHZRvot54.eKAkmdgg/xYz3cqX7C.NjgXX03nUfue','','admin','Mr',1,1,null,0,'');
INSERT INTO user (id, about, created, photo_id, email, firstname, logged, password, phone, surname, title, group_id, role_id, company_id, is_approved, token) VALUES (2, '',0,null,'user@user.com','user',0,'password','','user','Mr',1,1,null,0,'');
INSERT INTO user (id, about, created, photo_id, email, firstname, logged, password, phone, surname, title, group_id, role_id, company_id, is_approved, token) VALUES (3, '',0,null,'audit@audit.com','audit', 0,'password','','audit','Mr',1,1,null,0,'');
INSERT INTO user (id, about, created, photo_id, email, firstname, logged, password, phone, surname, title, group_id, role_id, company_id, is_approved, token) VALUES (4, '',0,null,'system@system.com','system',0,'password','','system','Mr',1,1,null,0,'');
INSERT INTO user (id, about, created, photo_id, email, firstname, logged, password, phone, surname, title, group_id, role_id, company_id, is_approved, token) VALUES (5, '',0,null,'angular@angular.com','angular',0,'password','','angular','Mr',1,1,null,0,'');
