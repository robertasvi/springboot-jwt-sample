...
INSERT INTO user (id, about, created, photo_id, email, firstname, logged, password, phone, surname, code, group_id, role_id, approved, sys_role) VALUES (1, '',0,null,'admin@admin.com','admin', 0,'{bcrypt}$2a$10$tDk/pDvQcXjN8qghkoV7bOEjLWmR/u8SKS8v36IaPBLdukgMLjmCm','','admin','ADM',1,1,1,'ADMIN');
INSERT INTO user (id, about, created, photo_id, email, firstname, logged, password, phone, surname, code, group_id, role_id, approved, sys_role) VALUES (2, '',0,null,'user@user.com','user',0,'password','','user','USR',1,1,1,'USER');
INSERT INTO user (id, about, created, photo_id, email, firstname, logged, password, phone, surname, code, group_id, role_id, approved, sys_role) VALUES (3, '',0,null,'audit@audit.com','audit', 0,'password','','audit','AUD',1,1,0,'USER');
INSERT INTO user (id, about, created, photo_id, email, firstname, logged, password, phone, surname, code, group_id, role_id, approved, sys_role) VALUES (4, '',0,null,'system@system.com','system',0,'password','','system','SYS',1,1,0,'ADMIN');
INSERT INTO user (id, about, created, photo_id, email, firstname, logged, password, phone, surname, code, group_id, role_id, approved, sys_role) VALUES (5, '',0,null,'angular@angular.com','angular',0,'password','','angular','NGU',1,1,0,'USER');
